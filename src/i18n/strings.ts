...
export const STRINGS = {
  he: {
    ...
    levels: {
      ...
      reviewCardTitle: 'מצב תרגול',
      reviewCardBody: 'בחנו את עצמכם על מה שכבר למדתם',
    ...
    success: {
      ...
      feedbackTitle: '🎉 סיימתם את כל האפליקציה!',
      feedbackBody: 'נשמח לשמוע מה חשבתם - זה עוזר לנו להשתפר.',
      feedbackPlaceholder: 'ספרו לנו מה אהבתם או מה כדאי לשפר (לא חובה)',
      feedbackSend: 'שליחת משוב',
      feedbackSkip: 'לא תודה',
    ...
    review: {
      ...
      prompt: 'איזו פקודה מתאימה לתמונה?',
      emptyState: 'השלימו לפחות רמה אחת כדי לפתוח את מצב התרגול.',
      scoreResult: (score: number, total: number) => `ענית נכון על ${score} מתוך ${total}!`,
      restartBtn: '🔄 תרגלו שוב',
    },
    agent: {
      back: 'חזרה',
      title: '🤖 עוזר אילוף',
    ...
    profile: {
      ...
      vibeLabel: 'האווירה של האפליקציה',
      vibeClassic: '🐕 קלאסי',
      vibeWolf: '🐺 זאבי',
      vibeHint: 'משנה את הצבעים והכלב באנימציה בכל האפליקציה - למשל למראה כהה ומגניב יותר להאסקי או לכלב-זאב.',
  ...
  en: {
    ...
    levels: {
      ...
      reviewCardTitle: 'Practice Mode',
      reviewCardBody: "Quiz yourself on what you've already learned",
    ...
    success: {
      ...
      feedbackTitle: '🎉 You finished the whole app!',
      feedbackBody: "We'd love to hear what you thought - it helps us improve.",
      feedbackPlaceholder: 'Tell us what you liked or what could be better (optional)',
    ...
    review: {
      ...
      prompt: 'Which command matches this picture?',
      emptyState: 'Complete at least one level to unlock practice mode.',
      scoreResult: (score: number, total: number) => `You got ${score} out of ${total} right!`,
    ...
    profile: {
      ...
      vibeClassic: '🐕 Classic',
      vibeWolf: '🐺 Wolf',
      vibeHint: "Changes the colors and the animated dog across the whole app - for a darker, cooler look that fits a husky or wolf-dog.",
