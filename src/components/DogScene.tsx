...
export type FurPack = 'classic' | 'wolf';

interface FurPalette {
  main: string; mid: string; dark: string; pad: string;
  light: string; muzzle: string; line: string; tongue: string;
}

// The dog's fur/skin colors, swappable by "vibe" (see ThemeContext's
// stylePack) independent of the human/props/environment colors below,
// which never change - only these 8 tones are used exclusively for the
// dog's body across every pose, so remapping just them is enough to give
// the whole character a different coat without touching its silhouette.
const FUR_PACKS: Record<FurPack, FurPalette> = {
  classic: {
    main: '#D4A055', mid: '#C89040', dark: '#C08030', pad: '#B87830',
    light: '#EEC070', muzzle: '#DCAA5A', line: '#A06828', tongue: '#D4608A',
  },
  wolf: {
    main: '#AEB6C2', mid: '#8A93A3', dark: '#5C6675', pad: '#3D4551',
    light: '#E5E9EE', muzzle: '#F2F2F2', line: '#4A5361', tongue: '#D4608A',
  },
};
...
function Tail({ wag, originX, originY, d, fur, widths = [10, 6] }: {
  wag: WagValue; originX: number; originY: number; d: string; fur: FurPalette; widths?: [number, number];
}) {
  return (
    <AnimatedG rotation={wag as unknown as number} originX={originX} originY={originY}>
      <Path d={d} stroke={fur.pad} strokeWidth={widths[0]} fill="none" strokeLinecap="round" />
      <Path d={d} stroke={fur.main} strokeWidth={widths[1]} fill="none" strokeLinecap="round" />
    </AnimatedG>
  );
}

function DogSit({ col, wag, fur }: { col: string; wag: WagValue; fur: FurPalette }) {
  return (
    <G>
      <Ellipse cx="100" cy="198" rx="36" ry="6" fill="#90B860" opacity="0.4" />
      <Ellipse cx="88" cy="182" rx="23" ry="19" fill={fur.main} />
      <Ellipse cx="113" cy="182" rx="19" ry="17" fill={fur.mid} />
      <Rect x="77" y="162" width="12" height="34" rx="6" fill={fur.main} />
      <Rect x="93" y="162" width="12" height="34" rx="6" fill={fur.mid} />
      <Ellipse cx="83" cy="197" rx="8" ry="4" fill={fur.pad} />
      <Ellipse cx="99" cy="197" rx="8" ry="4" fill={fur.pad} />
      <Ellipse cx="98" cy="156" rx="27" ry="21" fill={fur.main} />
      <Ellipse cx="98" cy="136" rx="16" ry="12" fill={fur.main} />
      <Rect x="83" y="142" width="29" height="7" rx="3" fill={col} />
      <Circle cx="98" cy="146" r="3" fill="#FFD166" />
      <Ellipse cx="98" cy="115" rx="23" ry="21" fill={fur.main} />
      <Ellipse cx="91" cy="111" rx="12" ry="9" fill={fur.light} opacity="0.5" />
      <Ellipse cx="78" cy="121" rx="9" ry="16" fill={fur.dark} rotation="-14" originX="78" originY="121" />
      <Ellipse cx="118" cy="121" rx="9" ry="16" fill={fur.dark} rotation="14" originX="118" originY="121" />
      <Ellipse cx="98" cy="128" rx="12" ry="9" fill={fur.mid} />
      <Ellipse cx="98" cy="124" rx="9" ry="6" fill={fur.muzzle} />
      ...
      <Path d="M91 131 Q98 138 105 131" stroke={fur.line} strokeWidth="1.5" fill="none" strokeLinecap="round" />
      <Ellipse cx="98" cy="133" rx="4" ry="3" fill={fur.tongue} opacity="0.85" />
      <Tail wag={wag} fur={fur} originX={122} originY={160} d="M122 160 Q141 141 146 126" />
    </G>
  );
}

function DogCome({ col, wag, fur }: { col: string; wag: WagValue; fur: FurPalette }) {
  return (
    <G>
      <Ellipse cx="100" cy="198" rx="36" ry="6" fill="#90B860" opacity="0.4" />
      <Ellipse cx="106" cy="168" rx="28" ry="14" fill={fur.main} rotation="-12" originX="106" originY="168" />
      <Rect x="80" y="170" width="11" height="24" rx="5" fill={fur.main} rotation="-25" originX="84" originY="170" />
      <Rect x="96" y="173" width="11" height="22" rx="5" fill={fur.mid} rotation="12" originX="100" originY="173" />
      <Rect x="114" y="170" width="11" height="22" rx="5" fill={fur.main} rotation="22" originX="118" originY="170" />
      <Rect x="128" y="168" width="11" height="22" rx="5" fill={fur.dark} rotation="-8" originX="132" originY="168" />
      <Ellipse cx="74" cy="196" rx="8" ry="4" fill={fur.pad} />
      <Ellipse cx="104" cy="198" rx="8" ry="4" fill={fur.pad} />
      <Ellipse cx="128" cy="196" rx="8" ry="4" fill={fur.pad} />
      <Ellipse cx="86" cy="155" rx="14" ry="10" fill={fur.main} />
      <Rect x="74" y="158" width="24" height="6" rx="3" fill={col} />
      <Circle cx="86" cy="161" r="2.5" fill="#FFD166" />
      <Ellipse cx="72" cy="142" rx="21" ry="19" fill={fur.main} />
      <Ellipse cx="65" cy="138" rx="11" ry="8" fill={fur.light} opacity="0.5" />
      <Ellipse cx="56" cy="143" rx="8" ry="13" fill={fur.dark} rotation="28" originX="56" originY="143" />
      <Ellipse cx="88" cy="139" rx="8" ry="12" fill={fur.dark} rotation="-12" originX="88" originY="139" />
      <Ellipse cx="54" cy="150" rx="11" ry="8" fill={fur.mid} />
      <Ellipse cx="51" cy="147" rx="6" ry="5" fill={fur.muzzle} />
      ...
      <Path d="M47 152 Q51 161 49 166 Q53 171 57 166 Q55 161 59 152" fill={fur.tongue} />
      <Tail wag={wag} fur={fur} originX={132} originY={163} d="M132 163 Q150 141 154 122" />
    </G>
  );
}

function DogDown({ col, wag, fur }: { col: string; wag: WagValue; fur: FurPalette }) {
  return (
    <G>
      <Ellipse cx="100" cy="198" rx="48" ry="6" fill="#90B860" opacity="0.4" />
      <Ellipse cx="104" cy="188" rx="44" ry="12" fill={fur.main} />
      <Ellipse cx="100" cy="183" rx="31" ry="8" fill={fur.light} opacity="0.5" />
      <Rect x="64" y="184" width="30" height="9" rx="4" fill={fur.dark} />
      <Rect x="128" y="184" width="28" height="9" rx="4" fill={fur.dark} />
      <Ellipse cx="64" cy="194" rx="9" ry="4" fill={fur.pad} />
      <Ellipse cx="150" cy="194" rx="9" ry="4" fill={fur.pad} />
      <Ellipse cx="78" cy="178" rx="13" ry="9" fill={fur.main} />
      <Rect x="67" y="181" width="22" height="6" rx="3" fill={col} />
      <Circle cx="78" cy="184" r="2.5" fill="#FFD166" />
      <Ellipse cx="65" cy="168" rx="20" ry="17" fill={fur.main} />
      <Ellipse cx="59" cy="164" rx="10" ry="7" fill={fur.light} opacity="0.5" />
      <Ellipse cx="49" cy="173" rx="8" ry="13" fill={fur.dark} rotation="14" originX="49" originY="173" />
      <Ellipse cx="81" cy="167" rx="8" ry="12" fill={fur.dark} rotation="-6" originX="81" originY="167" />
      <Ellipse cx="47" cy="178" rx="11" ry="7" fill={fur.mid} />
      <Ellipse cx="44" cy="176" rx="6" ry="4" fill={fur.muzzle} />
      ...
      <Tail wag={wag} fur={fur} originX={144} originY={190} d="M144 190 Q160 183 168 174" />
    </G>
  );
}

function CrateAndDog({ open, col, wag, fur }: { open: boolean; col: string; wag: WagValue; fur: FurPalette }) {
  return (
    <G>
      {/* Crate */}
      ...
      {/* Dog inside */}
      <Ellipse cx="62" cy="144" rx="30" ry="7" fill={fur.main} opacity="0.9" />
      <Ellipse cx="62" cy="138" rx="22" ry="6" fill={fur.light} opacity="0.5" />
      <Rect x="38" y="135" width="18" height="8" rx="4" fill={fur.dark} />
      <Ellipse cx="38" cy="143" rx="7" ry="3.5" fill={fur.pad} />
      <Rect x="48" y="130" width="18" height="6" rx="3" fill={col} />
      <Circle cx="57" cy="133" r="2" fill="#FFD166" />
      <Ellipse cx="44" cy="124" rx="16" ry="13" fill={fur.main} />
      <Ellipse cx="38" cy="120" rx="8" ry="6" fill={fur.light} opacity="0.5" />
      <Ellipse cx="29" cy="126" rx="7" ry="11" fill={fur.dark} rotation="12" originX="29" originY="126" />
      <Ellipse cx="58" cy="124" rx="7" ry="10" fill={fur.dark} rotation="-8" originX="58" originY="124" />
      <Ellipse cx="31" cy="130" rx="9" ry="6" fill={fur.mid} />
      <Ellipse cx="28" cy="128" rx="5" ry="4" fill={fur.muzzle} />
      ...
      <Tail wag={wag} fur={fur} originX={88} originY={141} d="M88 141 Q102 128 105 115" widths={[9, 5]} />
    </G>
  );
}

function DogLeaveClose({ col, wag, fur }: { col: string; wag: WagValue; fur: FurPalette }) {
  return (
    <G>
      {/* Bone */}
      ...
      <Ellipse cx="80" cy="181" rx="22" ry="18" fill={fur.main} />
      <Ellipse cx="104" cy="181" rx="18" ry="16" fill={fur.mid} />
      <Rect x="70" y="162" width="12" height="33" rx="6" fill={fur.main} />
      <Rect x="86" y="162" width="12" height="33" rx="6" fill={fur.mid} />
      <Ellipse cx="76" cy="196" rx="8" ry="4" fill={fur.pad} />
      <Ellipse cx="92" cy="196" rx="8" ry="4" fill={fur.pad} />
      <Ellipse cx="90" cy="156" rx="26" ry="20" fill={fur.main} />
      <Ellipse cx="90" cy="136" rx="15" ry="11" fill={fur.main} />
      <Rect x="76" y="142" width="28" height="7" rx="3" fill={col} />
      <Circle cx="90" cy="146" r="3" fill="#FFD166" />
      <Ellipse cx="102" cy="113" rx="22" ry="20" fill={fur.main} />
      <Ellipse cx="109" cy="108" rx="12" ry="9" fill={fur.light} opacity="0.5" />
      <Ellipse cx="82" cy="118" rx="9" ry="15" fill={fur.dark} rotation="-14" originX="82" originY="118" />
      <Ellipse cx="122" cy="116" rx="9" ry="14" fill={fur.dark} rotation="18" originX="122" originY="116" />
      <Ellipse cx="114" cy="125" rx="13" ry="9" fill={fur.mid} />
      <Ellipse cx="116" cy="121" rx="9" ry="6" fill={fur.muzzle} />
      ...
      <Tail wag={wag} fur={fur} originX={113} originY={158} d="M113 158 Q122 174 120 183" widths={[9, 5]} />
    </G>
  );
}

function DogLeaveBack({ col, wag, fur }: { col: string; wag: WagValue; fur: FurPalette }) {
  return (
    <G>
      <Rect x="148" y="192" width="18" height="5" rx="2" fill="#E8C080" />
      <Circle cx="148" cy="194" r="4" fill="#E8C080" />
      ...
      <Ellipse cx="77" cy="181" rx="22" ry="18" fill={fur.main} />
      <Ellipse cx="101" cy="181" rx="18" ry="16" fill={fur.mid} />
      <Rect x="67" y="162" width="12" height="33" rx="6" fill={fur.main} />
      <Rect x="83" y="162" width="12" height="33" rx="6" fill={fur.mid} />
      <Ellipse cx="73" cy="196" rx="8" ry="4" fill={fur.pad} />
      <Ellipse cx="89" cy="196" rx="8" ry="4" fill={fur.pad} />
      <Ellipse cx="87" cy="156" rx="25" ry="20" fill={fur.main} />
      <Ellipse cx="87" cy="136" rx="15" ry="11" fill={fur.main} />
      <Rect x="73" y="142" width="28" height="7" rx="3" fill={col} />
      <Circle cx="87" cy="146" r="3" fill="#FFD166" />
      <Ellipse cx="87" cy="113" rx="22" ry="20" fill={fur.main} />
      <Ellipse cx="80" cy="109" rx="12" ry="9" fill={fur.light} opacity="0.5" />
      <Ellipse cx="67" cy="119" rx="9" ry="15" fill={fur.dark} rotation="-14" originX="67" originY="119" />
      <Ellipse cx="107" cy="119" rx="9" ry="15" fill={fur.dark} rotation="14" originX="107" originY="119" />
      <Ellipse cx="87" cy="125" rx="12" ry="9" fill={fur.mid} />
      <Ellipse cx="87" cy="121" rx="9" ry="6" fill={fur.muzzle} />
      ...
      <Path d="M80 129 Q87 135 94 129" stroke={fur.line} strokeWidth="1.5" fill="none" strokeLinecap="round" />
      <Ellipse cx="87" cy="131" rx="4" ry="3" fill={fur.tongue} opacity="0.7" />
      <SvgText x="87" y="90" textAnchor="middle" fontSize="18" fill="#06D6A0" fontWeight="800">V</SvgText>
      <Tail wag={wag} fur={fur} originX={109} originY={160} d="M109 160 Q128 141 132 126" />
    </G>
  );
}

function DogLeaveWalk({ col, wag, language, fur }: { col: string; wag: WagValue; language: Language; fur: FurPalette }) {
  return (
    <G>
      ...
      <Ellipse cx="63" cy="181" rx="21" ry="17" fill={fur.main} />
      <Ellipse cx="86" cy="181" rx="17" ry="15" fill={fur.mid} />
      <Rect x="54" y="163" width="11" height="32" rx="5" fill={fur.main} />
      <Rect x="69" y="163" width="11" height="32" rx="5" fill={fur.mid} />
      <Ellipse cx="60" cy="196" rx="7" ry="4" fill={fur.pad} />
      <Ellipse cx="74" cy="196" rx="7" ry="4" fill={fur.pad} />
      <Ellipse cx="72" cy="156" rx="24" ry="19" fill={fur.main} />
      <Ellipse cx="72" cy="137" rx="14" ry="11" fill={fur.main} />
      <Rect x="59" y="143" width="26" height="6" rx="3" fill={col} />
      <Circle cx="72" cy="146" r="2.5" fill="#FFD166" />
      <Ellipse cx="72" cy="114" rx="21" ry="19" fill={fur.main} />
      <Ellipse cx="66" cy="110" rx="11" ry="8" fill={fur.light} opacity="0.5" />
      <Ellipse cx="53" cy="119" rx="8" ry="14" fill={fur.dark} rotation="-14" originX="53" originY="119" />
      <Ellipse cx="91" cy="119" rx="8" ry="14" fill={fur.dark} rotation="14" originX="91" originY="119" />
      <Ellipse cx="72" cy="125" rx="11" ry="8" fill={fur.mid} />
      <Ellipse cx="72" cy="121" rx="8" ry="6" fill={fur.muzzle} />
      ...
      <Path d="M65 128 Q72 135 79 128" stroke={fur.line} strokeWidth="1.5" fill="none" strokeLinecap="round" />
      <Ellipse cx="72" cy="130" rx="4" ry="3" fill={fur.tongue} opacity="0.85" />
      ...
      <Tail wag={wag} fur={fur} originX={93} originY={158} d="M93 158 Q110 139 114 124" />
    </G>
  );
}

function DogWalkPull({ col, wag, fur }: { col: string; wag: WagValue; fur: FurPalette }) {
  return (
    <G>
...
function DogWalkSit({ col, wag, fur }: { col: string; wag: WagValue; fur: FurPalette }) {
  return (
    <G>
...
function DogWalkStay({ col, wag, language, fur }: { col: string; wag: WagValue; language: Language; fur: FurPalette }) {
  return (
    <G>
...
function DogTrickPaw({ col, wag, fur }: { col: string; wag: WagValue; fur: FurPalette }) {
  return (
    <G>
      <Ellipse cx="100" cy="198" rx="36" ry="6" fill="#90B860" opacity="0.4" />
      <Ellipse cx="88" cy="182" rx="23" ry="19" fill={fur.main} />
      ...
      <Rect x="100" y="168" width="11" height="26" rx="5" fill={fur.main} rotation="-55" originX="100" originY="180" />
      <Ellipse cx="123" cy="163" rx="8" ry="5" fill={fur.pad} rotation="-30" originX="123" originY="163" />
      <Tail wag={wag} fur={fur} originX={122} originY={160} d="M122 160 Q141 141 146 126" />
    </G>
  );
}

function DogTrickHigh5({ col, wag, fur }: { col: string; wag: WagValue; fur: FurPalette }) {
  return (
    <G>
      <Ellipse cx="100" cy="198" rx="36" ry="6" fill="#90B860" opacity="0.4" />
      <Ellipse cx="88" cy="182" rx="23" ry="19" fill={fur.main} />
      ...
      <Rect x="103" y="128" width="11" height="34" rx="5" fill={fur.main} rotation="-72" originX="103" originY="160" />
      <Ellipse cx="132" cy="120" rx="8" ry="5" fill={fur.pad} rotation="-15" originX="132" originY="120" />
...
function DogTrickSpin({ col, wag, fur }: { col: string; wag: WagValue; fur: FurPalette }) {
  return (
    <G>
...
// meaningful win.
function DogScene({ illustration, language, size = 300, furPack = 'classic' }: DogSceneProps) {
  const col = collarColors[illustration] || '#FF6B35';
  const fur = FUR_PACKS[furPack];
  ...
  return (
    <Animated.View style={{ transform: [{ translateY }, { scaleX }, { scaleY }] }}>
      <Svg width={size} height={size * 0.66} viewBox="0 0 320 210">
        ...
        {isCrateScene && <CrateAndDog open={isOpen} col={col} wag={wag} fur={fur} />}
        ...
        {!isCrateScene && (
          <G>
            {illustration === 'sit' && <DogSit col={col} wag={wag} fur={fur} />}
            {illustration === 'come' && <DogCome col={col} wag={wag} fur={fur} />}
            {illustration === 'down' && <DogDown col={col} wag={wag} fur={fur} />}
            {illustration === 'leave_close' && <DogLeaveClose col={col} wag={wag} fur={fur} />}
            {illustration === 'leave_back' && <DogLeaveBack col={col} wag={wag} fur={fur} />}
            {illustration === 'leave_walk' && <DogLeaveWalk col={col} wag={wag} fur={fur} language={language} />}
            {illustration === 'walk_pull' && <DogWalkPull col={col} wag={wag} fur={fur} />}
            {illustration === 'walk_sit' && <DogWalkSit col={col} wag={wag} fur={fur} />}
            {illustration === 'walk_stay' && <DogWalkStay col={col} wag={wag} fur={fur} language={language} />}
            {illustration === 'trick_paw' && <DogTrickPaw col={col} wag={wag} fur={fur} />}
            {illustration === 'trick_high5' && <DogTrickHigh5 col={col} wag={wag} fur={fur} />}
            {illustration === 'trick_spin' && <DogTrickSpin col={col} wag={wag} fur={fur} />}
            {/* Levels 6-10 reuse the poses above under new keys, so each gets
                its own level color/bubble text without new SVG drawings. */}
            {(illustration === 'stay2_sit' || illustration === 'recall2_sit' || illustration === 'combo_sit') && <DogSit col={col} wag={wag} fur={fur} />}
            {(illustration === 'stay2_come' || illustration === 'recall2_come' || illustration === 'field_go' || illustration === 'combo_come') && <DogCome col={col} wag={wag} fur={fur} />}
            {(illustration === 'recall2_down' || illustration === 'field_stop' || illustration === 'combo_down') && <DogDown col={col} wag={wag} fur={fur} />}
            {illustration === 'field_heel' && <DogWalkSit col={col} wag={wag} fur={fur} />}
            {illustration === 'stay2_wait' && <DogWalkStay col={col} wag={wag} fur={fur} language={language} />}
            {illustration === 'social_wave' && <DogTrickPaw col={col} wag={wag} fur={fur} />}
            {illustration === 'social_kiss' && <DogTrickHigh5 col={col} wag={wag} fur={fur} />}
            {illustration === 'social_dance' && <DogTrickSpin col={col} wag={wag} fur={fur} />}
          </G>
        )}
      </Svg>
    </Animated.View>
